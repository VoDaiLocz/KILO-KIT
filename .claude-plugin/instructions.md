# Kilo-Kit — Claude Code Plugin

> Entry point for Claude Code integration.

## Setup

This directory enables Kilo-Kit as a plugin for **Claude Code**.

To activate, reference the master skill in your Claude Code configuration:
